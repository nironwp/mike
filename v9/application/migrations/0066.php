<?php
class Migration_66 extends Migration {

    const DESCRIPTION_RU = 'Создание таблицы index_device_models';

    const DESCRIPTION_EN = 'Create table index_device_models';

    public static function up()
    {
        $table = self::getDb()->getPrefix() . 'index_device_models';
