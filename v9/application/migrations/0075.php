<?php
class Migration_75 extends Migration {

    const DESCRIPTION_RU = 'Создание таблицы index_isp';

    const DESCRIPTION_EN = 'Create table index_isp';

    public static function up()
    {
        $sql = 'CREATE TABLE IF NOT EXISTS ' . self::getDb()->getPrefix() . 'index_isp (
