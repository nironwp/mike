<?php
class Migration_54 extends Migration {

    const DESCRIPTION_RU = 'Создание таблицы index_regions';

    const DESCRIPTION_EN = 'Create table index_regions';

    public static function up()
    {
        $table = self::getDb()->getPrefix() . 'index_regions';
