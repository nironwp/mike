<?php
class Migration_55 extends Migration {

    const DESCRIPTION_RU = 'Создание таблицы index_cities';

    const DESCRIPTION_EN = 'Create table index_cities';

    public static function up()
    {
        $table = self::getDb()->getPrefix() . 'index_cities';
